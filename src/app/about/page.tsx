...
export default function AboutPage() {
  ...
  const projects = [
    {
      name: 'AnonHost',
      description: 'AnonHost aims to provide a free, private and user-first solution for uploading files, sharing code and shortening URLs',
      tech: ['React', 'TypeScript', 'Node.js', 'TailwindCSS', 'PostgreSQL', 'Git', 'Pnpm', 'PM2', 'Prisma'],
      link: '/',
    },
    {
      name: 'uwurs',
      description: 'uwurs is a rust library I worked on to learn the Rust programming language. It is fairly simple and just functions as a text formatting tool.',
      tech: ['Git', 'Rust'],
      link: 'https://github.com/KeiranScript/uwurs',
    },
    {
      name: 'Archium',
      description: 'A fork of the Archie project aiming to improve the UX for Arch Linux users by acting as a wrapper for the two most popular pacman wrappers, Paru and YAY.',
    ...
    >
      <motion.div className="text-center mb-16" variants={itemVariants}>
        <h1 className="text-6xl font-extrabold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-primary to-secondary">
          <TextGenerateEffect words="Keiran" className="dark:text-white text-black" duration={1} />
        </h1>
      ...
      <motion.div className="flex flex-col items-center mb-16 space-y-8" variants={itemVariants}>
      ...
      >
                ...
                >
                  <Card className="p-6 hover:shadow-lg transition-all duration-300 hover:scale-[1.01]">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                      Lorem, ipsum dolor sit amet consectetur adipisicing elit. Totam dolor harum magni hic exercitationem suscipit, non cupiditate? Autem, fuga repudiandae aliquid beatae, tempora blanditiis ipsa quaerat ratione maxime quidem nihil!
                    </p>
                    <div className="mt-8">
                      <h3 className="text-lg font-medium mb-4 text-muted-foreground">Discord Presence</h3>
        ...
        >
          <p className="flex items-center justify-center gap-1">
            Made with <Heart className="w-4 h-4 text-red-500 animate-pulse" /> using Next.js and Tailwind
          </p>
        </motion.div>
      </motion.div>
    </motion.div>
